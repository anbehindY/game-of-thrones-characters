...
Game of thrones characters is a single-page web application created with CRA CLI. A list of houses from the GOT TV shows are displayed and in each family there are a list of characters provided by the API. Each family can also be searched through the search input of the home page. For the styling of the web page, I used the Creative Commons design created by [Nelson Sakwa](https://www.behance.net/sakwadesignstudio).
